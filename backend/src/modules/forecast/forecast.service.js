...
const FORECAST_PATH = '/api/v1/forecasts';
...
function buildAiUrl() {
  ...
  return new globalThis.URL(FORECAST_PATH, baseUrl).toString();
}

async function createForecast(payload) {
  ...
  try {
    ...
    throw new AppError(
      `Unable to reach AI forecast service: ${error.message}`,
      502,
