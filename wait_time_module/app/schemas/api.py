...
from app.domain.models import ClinicalPriority,PresenceStatus,TaskType
...
class PatientEstimate(BaseModel):
    patient_token:str;journey_id:str;queue_id:str;task_type:str;clinical_priority:str;readiness_status:str
...
class RoomOptionsRequest(BaseModel):
    request_id:str;patient_token:str;task_type:TaskType;service_code:str;clinical_priority:ClinicalPriority;ready_at:datetime;candidate_room_ids:list[str];dry_run:bool=True
